...
const editProjectSchema = z.object({
  ...
  status: z.enum(['PLANNING', 'ACTIVE', 'ON_HOLD', 'COMPLETED', 'ARCHIVED', 'CANCELLED']),
...
export default function ProjectSettingsPage() {
  ...
  return (
    <div className="space-y-8 max-w-2xl">
      <PageHeader title="Project Settings" description="Update this project's configuration." />
          ...
          <div className="flex items-center justify-between p-4 border rounded-lg">
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Hides the project from the active list but keeps all data.
              </p>
            </div>
            <Button
              variant="outline"
      ...
      <ConfirmDialog
        ...
        description={`Are you sure you want to archive "${project?.name}"? You can restore it later.`}
        confirmLabel="Archive"
        onConfirm={onArchive}
        isLoading={archiveProject.isPending}
      />

      {/* Delete Confirm with name input */}
      <Dialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
        <DialogContent className="sm:max-w-md">
          ...
          <div className="space-y-4">
            <p className="text-sm text-muted-foreground">
              This action is permanent and cannot be undone. All tasks, comments, and data
